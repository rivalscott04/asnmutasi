        ...
        <div class="col-lg-8">
            <div class="card border-0 shadow">
                <div class="card-header bg-warning text-dark text-center py-4">
                    ...
                    <p class="mb-0 mt-2 opacity-75">Isi data berikut untuk membuat surat pernyataan tidak pernah dijatuhi hukuman disiplin</p>
                </div>
                ...
                <div class="card-body p-4">
                    ...
                    <form id="suratForm" method="POST" action="/surat/pernyataan-disiplin">
                        ...
                        <div class="mb-3">
                            <label for="ukerpejabat" class="form-label">Satuan Kerja Pejabat <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" id="ukerpejabat" name="ukerpejabat" 
                                   value="<?= htmlspecialchars($old['ukerpejabat'] ?? '') ?>" 
                                   placeholder="Satuan kerja pejabat" required>
                        </div>
                        ...
                        <div class="d-flex justify-content-between mt-5">
                            ...
                            <div>
                                <button type="button" class="btn btn-outline-warning me-2" onclick="previewSurat()">
            ...
            <div class="card border-0 shadow-sm mt-4">
                <div class="card-body">
                    ...
                    <ul class="text-muted small mb-0">
                        <li>Surat pernyataan ini menyatakan bahwa pegawai tidak pernah dijatuhi hukuman disiplin</li>
                        <li>Hukuman disiplin yang dimaksud adalah tingkat sedang dan berat sesuai PP No. 53 Tahun 2010</li>
                        <li>Periode kerja harus mencakup seluruh masa kerja sebagai PNS</li>
                        <li>Pernyataan yang tidak benar dapat dikenakan sanksi sesuai peraturan</li>
                        <li>Dokumen ini biasanya diperlukan untuk keperluan mutasi atau promosi</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">
                    <i class="fas fa-eye me-2"></i>
                    Preview Surat Pernyataan Disiplin
                </h5>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-warning text-dark" onclick="generateFromPreview()">
                    <i class="fas fa-download me-2"></i>
                    Generate Surat
                </button>
            </div>
...
function previewSurat() {
    ...
    console.log("=== PAYLOAD DATA PREVIEW SURAT PERNYATAAN DISIPLIN ===");
    const payloadData = {};
    ...
    fetch("/surat/pernyataan-disiplin/preview", {
        method: "POST",
        body: formData
    })
...
document.getElementById("suratForm").addEventListener("submit", function(e) {
    ...
    // Log payload data for debugging
    console.log("=== PAYLOAD DATA SUBMIT SURAT PERNYATAAN DISIPLIN ===");
    const payloadData = {};
    for (let [key, value] of formData.entries()) {
        payloadData[key] = value;
        console.log(`${key}: ${value}`);
