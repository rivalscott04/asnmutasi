...
/**
 * Surat SPTJM Controller
 * Menangani pembuatan surat pernyataan tanggung jawab mutlak
 */
class SuratSptjmController extends BaseController
{
    /**
     * Form Surat SPTJM
     */
    ...
    public function generate()
    {
        try {
            ...
            return $this->generateSurat('surat_sptjm', $validated);
    ...
    public function preview()
    {
        try {
            ...
            // Load template
            $templatePath = ROOT_PATH . '/templates/surat_sptjm.html';
