...
/**
 * Surat Pernyataan Disiplin Controller
 * Menangani pembuatan surat pernyataan tidak sedang dalam proses hukuman disiplin
 */
class SuratPernyataanDisiplinController extends BaseController
{
    /**
     * Form Surat Pernyataan Disiplin
     */
    ...
    public function generate()
    {
        try {
            ...
            $validated = $this->validate([
                ...
                'ukerpejabat' => 'required|string|max:200'
            ]);
            ...
            return $this->generateSurat('surat_pernyataan_disiplin_new', $validated);
    ...
    public function preview()
    {
        try {
            ...
            // Load template
            $templatePath = ROOT_PATH . '/templates/surat_pernyataan_disiplin_new.html';
