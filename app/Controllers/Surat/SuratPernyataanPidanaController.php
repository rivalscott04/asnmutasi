...
/**
 * Surat Pernyataan Pidana Controller
 * Menangani pembuatan surat pernyataan tidak pernah dipidana
 */
class SuratPernyataanPidanaController extends BaseController
{
    /**
     * Form Surat Pernyataan Pidana
     */
    ...
    public function generate()
    {
        try {
            ...
            return $this->generateSurat('surat_pernyataan_pidana', $validated);
    ...
    /**
     * Preview Surat Pernyataan Pidana
     */
    public function preview()
    {
        try {
            ...
            // Load template
            $templatePath = ROOT_PATH . '/templates/surat_pernyataan_pidana.html';
